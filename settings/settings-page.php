...
function render_theme_settings_page()
{
    ...
    $snippet_disable_classic_editor = get_option('snippet_disable_classic_editor', 0);
                ...
                <div class="section-content">
                    ...
                    <div class="snippet-options-container">
                        ...
                        $snippets_disable = [
                            ...
                            'disable_classic_editor'   => 'Disable Classic Editor for All Pages'                      
                         ];
...
function initialize_theme_settings()
{
    ...
    register_setting('theme_settings_group', 'snippet_disable_classic_editor'); 
