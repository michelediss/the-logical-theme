<?php
/**
 * Hero Split layout template part.
 *
 * @var array $args
 */
...
?>
<section class="hero hero-split py-5 <?php echo esc_attr($section_class); ?>">
    <div class="<?php echo esc_attr($container_class); ?>">
        <div class="hero-split__shell row g-0 align-items-stretch overflow-hidden<?php echo esc_attr($rounded_class); ?>">
            <div class="hero-split__content col-12 col-lg-6 d-flex align-items-center p-4 p-lg-5">
                <div>
                    <?php if ($title !== ''): ?>
                        <h1 class="hero-split__title heading text-2xl mb-3"><?php echo esc_html($title); ?></h1>
                    <?php endif; ?>

                    <?php if ($text !== ''): ?>
                        <p class="hero-split__text paragraph text-base mb-4"><?php echo esc_html($text); ?></p>
                    <?php endif; ?>

                    <?php if ($cta_text !== '' && $cta_url !== ''): ?>
                        <a href="<?php echo esc_url($cta_url); ?>" class="hero-split__cta button heading text-sm text-uppercase rounded-pill text-decoration-none px-4 py-2"<?php echo $target_attr . $rel_attr; ?>>
            ...
            <div class="col-12 col-lg-6">
                <?php if ($image_url): ?>
                    <img src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($image_alt ?: $title); ?>" class="hero-split__image w-100 h-100">
                <?php else: ?>
                    <div class="hero-split__image-placeholder w-100 h-100"></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
