...
<div id="lcc-banner" class="lcc-hidden" role="dialog" aria-modal="true" aria-labelledby="lcc-banner-title" aria-describedby="lcc-banner-desc" tabindex="-1">
  <div class="lcc-card">
    <div class="lcc-title heading bold-italic text-lg text-secondary" id="lcc-banner-title"><?php echo esc_html__('Impostazioni dei cookie', 'lcc'); ?></div>
    <div class="lcc-desc paragraph regular text-base text-gray" id="lcc-banner-desc">
      ...
      <p class="lcc-desc-link mt-2 paragraph text-base text-gray">Per ulteriori informazioni consulta la
        <a href="<?php echo esc_url($cookie_policy_url); ?>" target="_blank" rel="noopener" class="text-primary paragraph text-decoration-none bold">
      ...
      ?>
        <div class="lcc-row lcc-row-details" data-lcc-cookie-row="<?php echo esc_attr($key); ?>">
          ...
          <div class="lcc-row-main">
            <span class="text-secondary text-base paragraph"><?php echo esc_html($label); ?></span>
