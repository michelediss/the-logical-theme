    ...
    <div class="container">
        ...
        ?>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="d-block">
                    <a href="mailto:info@yourdomain" class="text-base paragraph text-light text-decoration-none mb-4">info@yourdomain</a><br>
                    <a href="tel:1122334455" class="text-base paragraph text-light text-decoration-none mb-4">+39 339 112 2334</a>
                    <br><br>
